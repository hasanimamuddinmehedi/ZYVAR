...
export default function ProductCollage() {
  return (
    <section className="relative py-24 overflow-hidden">
      {/* Glow */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-[#C6922B]/10 blur-[120px]" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="relative flex justify-center">
          {/* Background Glow */}
          <div className="absolute w-[550px] h-[550px] rounded-full bg-[#C6922B]/10 blur-[120px]" />
          ...
          <motion.div
            ...
            className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl"
          >
            {/* COLUMN 1 */}
            <div className="space-y-6 mt-10">
              ...
              <motion.div
                ...
                className="overflow-hidden rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl transition duration-500"
              >
                <img
